...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#indexTable').DataTable({
		    ...
		    "order": [],
		    "ajax": {
		      "url": "<?php echo site_url('ref/list_tariff_denda') ?>",
		      "type": "POST"
		    },
		    "columnDefs": [
		    ...
		    "language": {
		    	searchPlaceholder: "Code / Name / Amount"
		    }
		});
	}); //end document ready
	...
	function edit_record(id) {
		...
		$.ajax({
			url : "<?php echo site_url('ref/get_tariff_denda_by_id/')?>",
			type: "POST",
			data: {"Id": id},
			dataType: "JSON",
	...
	function delete_record(id, code) {
	    if(confirm('Are you sure delete tariff code : '+ code +'?')) {
	        $.ajax({
	            url : "<?php echo site_url('ref/delete_tariff_denda')?>",
	            type: "POST",
	            data: {"Id": id},
	            dataType: "JSON",
	            success: function(data) {
	...
	function save() {
	    ...
	    if(save_method == 'add') {
	        url = "<?php echo site_url('ref/add_tariff_denda')?>";
	    } else {
	        url = "<?php echo site_url('ref/edit_tariff_denda')?>";
	    }
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="Amount" name="Amount" placeholder="0" class="form-control currency" type="text" maxlength="7">
                                <span class="help-block"></span>
                            </div>
                        </div>
